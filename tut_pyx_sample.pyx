...
cdef public double node_x, node_y, node_z, node_vx, node_vy, node_vz, node_m
...
cdef void single_step(node_x, node_y, node_z, dt):
    node_x = node_x
    node_y = node_y
    node_z = node_z
...
step_time(node_x,node_y, node_z, 5, 40000)
